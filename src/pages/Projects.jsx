    ...
    <section id="projects" className=" md:h-full mb-12 md:ml-[40%] md:pl-24 mt-12 md:mt-0">
      ...
      >
        <div className="text-center md:text-start">
          <h1 className="head1 text-black dark:text-white">FEATURED</h1>
          <h1 className="head1 text-black dark:text-neutral-700 -mt-16"> PROJECTS</h1>
        </div>
      </motion.div>
      <div className="grid md:grid-cols-2 grid-cols-1 justify-center gap-8 px-6 md:px-0 md:pr-6 mt-6">
        {projects.map((project, index) => (
          ...
          >
            <div className="card bg-white  border-2  border-black dark:border-transparent transition-all ease-in-out dark:bg-primary p-6 rounded-3xl flex flex-col justify-between">
              <h3 className="text-2xl font-semibold text-black dark:text-gray-200 mb-4">
                {project.title}
              </h3>
              <img
                ...
                width="100%"
              />
              <p className="text-sm text-black dark:text-gray-200">{project.description}</p>
              <div className=" mt-4">
                {project.githubUrl && (
